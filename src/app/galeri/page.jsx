      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg overflow-hidden">
            <Image src="/gambar1.png" alt="Gambar 1" className="w-full h-auto" />
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            <Image src="/gambar2.png" alt="Gambar 2" className="w-full h-auto" />
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            <Image src="/gambar3.png" alt="Gambar 3" className="w-full h-auto" />
            <div className="p-4">
