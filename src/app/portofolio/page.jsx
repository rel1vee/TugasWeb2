      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="/project4.png" alt="Proyek 1: YouTube Transcriber" className="w-full h-auto" />
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="/project5.png" alt="Proyek 2: Code Assistant" className="w-full h-auto" />
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="/project2.png" alt="Proyek 3: Jadwal Salat" className="w-full h-auto" />
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="/project3.png" alt="Proyek 4: ChatBot" className="w-full h-auto" />
            <div className="p-6">
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-md">
            <img src="/project1.png" alt="Proyek 5: Sliding-Puzzle Solver" className="w-full h-auto" />
            <div className="p-6">
